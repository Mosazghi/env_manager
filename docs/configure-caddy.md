...
Navigate to the [Caddy download page](https://caddyserver.com/download) and follow the instructions for your platform to install Caddy.
...
- Ports **80** and **443** are open and forwarded to this machine on your router (important step)
- `envms` is already running on port `8080`
